import { COMPARE_COLOR, DEFAULT_COLOR, SWAP_COLOR, INPLACE_COLOR } from "./main.js";
var x;
    ...
    x = setInterval(() => {
        ...
        switch(currAnim.type)
        {
            case 'changeColor':
                ...
                if(currAnim.a != -1)
                    elements[currAnim.a].style.backgroundColor = COMPARE_COLOR;
                if(currAnim.b != -1)
                    elements[currAnim.b].style.backgroundColor = COMPARE_COLOR;
                break;
            case 'reverseColor':
                ...
                if(currAnim.b != -1) 
                    elements[currAnim.b].style.backgroundColor = DEFAULT_COLOR;
                break;
            case 'swap':
                ...
                elements[currAnim.a].style.height = `${elements[currAnim.b].style.height}`;
